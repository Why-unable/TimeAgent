...
TIME_MEMORY_SEMANTIC_EXTRACTION_ENABLED = (
    os.getenv("TIME_MEMORY_SEMANTIC_EXTRACTION_ENABLED", "false").lower() == "true"
)
TIME_MEMORY_AGENT_SEARCH_TOOL_ENABLED = (
    os.getenv("TIME_MEMORY_AGENT_SEARCH_TOOL_ENABLED", "false").lower() == "true"
)
TIME_MEMORY_AGENT_WRITE_TOOLS_ENABLED = (
    os.getenv("TIME_MEMORY_AGENT_WRITE_TOOLS_ENABLED", "false").lower() == "true"
)
